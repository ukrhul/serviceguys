        ...
        <div class="col-md-7 mb-5"  data-aos="fade">
          ...
          <form method="POST" action="/create-post" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <input id="post_title" type="text" class="form-control @error('Title') is-invalid @enderror" name="post_title" value="{{ old('post_title') }}" required autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                    <textarea id="post_description" type="text" class="form-control @error('Description') is-invalid @enderror" name="post_description" value="{{ old('post_description') }}" required autofocus >
                    </textarea>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-3">
                ...
                <div class="input-group mb-2">
                  ...
                  <input id="post_min_price" type="text" class="form-control @error('Price') is-invalid @enderror" name="post_min_price" value="{{ old('post_min_price') }}" required autofocus>
                </div>
